...
<div id="Content">
	...
	<div class="CategoriesBlocks" id="ProgrammaturaBlock"><br><a class="CategoriesBlocksHref" href="../OfisaProgrammatura/ofisa_programmatura.php">Ofisa programmatūra</a><br><br><a class="CategoriesBlocksHref" href="operetajsistemas.php">Operētājsistēmas</a><br><br><a class="CategoriesBlocksHref" href="antivirusi.php">Antivīrusi</a></div>
	...
	<div id="ContentRight">
		<div id="ContentRightHeader">
			<div id="ContentRightHeaderLogo"><img id="ImgContentRightHeaderLogo" src="../../Images/Operetajsistemas/operetajsistemas.png"></div>
		</div>
			<div id="ContentRightFooter">
				<div id="InputForms">
					<form method="post">
					<div class="InputBlock">Preces nosaukums:&nbsp;<input type="text" name="PrecesMosaukums" class="InputText" placeholder="Preces nosaukums"></div><br>
