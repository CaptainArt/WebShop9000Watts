...
<div id="Content">
	...
	<div class="CategoriesBlocks" id="EnergijasAvotiBlock"><br><a class="CategoriesBlocksHref" href="../LadesanasIerices/ladesanas_ierices.php">Lādēšanas ierīces</a><br><br><a class="CategoriesBlocksHref" href="../Pagarinataji/pagarinataji.php">Pagarinātāji</a><br><br><a class="CategoriesBlocksHref" href="baterijas.php">Baterijas</a></div>
	...
	<div id="ContentRight">
		<div id="ContentRightHeader">
			<div id="ContentRightHeaderLogo"><img id="ImgContentRightHeaderLogo" src="../../Images/Baterijas/baterijas.png"></div>
		</div>
			<div id="ContentRightFooter">
				<div id="InputForms">
					...
					<div class="InputBlock">Preces akcijas cena:&nbsp;<input type="text" name="PreceAkcijasCena" class="InputText" placeholder="PrecesAkcijasCena"></div><br>
