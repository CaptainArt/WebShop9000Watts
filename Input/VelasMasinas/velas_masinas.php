...
<div id="Content">
	...
	<div class="CategoriesBlocks" id="SadzivesTehnikaBlock"><br><a class="CategoriesBlocksHref" href="velas_masinas.php">Veļas mašīnas</a><br><br><a class="CategoriesBlocksHref" href="../Ledusskapji/ledusskapji.php">Ledusskapji</a><br><br><a class="CategoriesBlocksHref" href="../Tejkannas/tejkannas.php">Tejkannas</a></div>
	...
	<div id="ContentRight">
		<div id="ContentRightHeader">
			<div id="ContentRightHeaderLogo"><img id="ImgContentRightHeaderLogo" src="../../Images/VelasMasinas/velas_masinas.png"></div>
		</div>
			<div id="ContentRightFooter">
				<div id="InputForms">
					...
					<div class="InputBlock">Ietilpība:&nbsp;<input type="text" name="Ietilpiba" class="InputText" placeholder="Ietilpība"></div><br>
					<div class="InputBlock">Klase:&nbsp;<input type="text" name="Klase" class="InputText" placeholder="Klase"></div><br>
					<div class="InputBlock">Centrifūga:&nbsp;<input type="text" name="Centrifuga" class="InputText" placeholder="Centrifūga"></div><br>
					<div class="InputBlock">Programmas:&nbsp;<input type="text" name="Programmas" class="InputText" placeholder="Programmas"></div><br>
