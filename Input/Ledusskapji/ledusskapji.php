...
<div id="Content">
	...
	<div class="CategoriesBlocks" id="SadzivesTehnikaBlock"><br><a class="CategoriesBlocksHref" href="../VelasMasinas/velas_masinas.php">Veļas mašīnas</a><br><br><a class="CategoriesBlocksHref" href="ledusskapji.php">Ledusskapji</a><br><br><a class="CategoriesBlocksHref" href="../Tejkannas/tejkannas.php">Tejkannas</a></div>
	...
	<div id="ContentRight">
		<div id="ContentRightHeader">
			<div id="ContentRightHeaderLogo"><img id="ImgContentRightHeaderLogo" src="../../Images/Ledusskapji/ledusskapji.png"></div>
		</div>
			<div id="ContentRightFooter">
				<div id="InputForms">
					...
					<div class="InputBlock">Klase:&nbsp;<input type="text" name="Klase" class="InputText" placeholder="Klase"></div><br>
					<div class="InputBlock">Tilpums:&nbsp;<input type="text" name="Tilpums" class="InputText" placeholder="Tilpums"></div><br>
					<div class="InputBlock">Saldētavas tilpums:&nbsp;<input type="text" name="SaldetavasTilpums" class="InputText" placeholder="Saldētavas tilpums"></div><br>
					<div class="InputBlock">Augstums:&nbsp;<input type="text" name="Augstums" class="InputText" placeholder="Augstums"></div><br>
