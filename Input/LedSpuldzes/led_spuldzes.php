...
<div id="Content">
	...
	<div class="CategoriesBlocks" id="ApgaismojumsBlock"><br><a class="CategoriesBlocksHref" href="../EnergoekonomiskasSpuldzes/energoekonomiskas_spuldzes.php">Energoekonomiskās spuldzes</a><br><br><a class="CategoriesBlocksHref" href="led_spuldzes.php">LED Spuldzes</a><br><br><a class="CategoriesBlocksHref" href="../Lukturi/lukturi.php">Lukturi</a></div>
	...
	<div id="ContentRight">
		<div id="ContentRightHeader">
			<div id="ContentRightHeaderLogo"><img id="ImgContentRightHeaderLogo" src="../../Images/LedSpuldzes/led_spuldzes.png"></div>
		</div>
			<div id="ContentRightFooter">
				<div id="InputForms">
					...
					<div class="InputBlock">Jauda:&nbsp;<input type="text" name="Jauda" class="InputText" placeholder="Jauda"></div><br>
					<div class="InputBlock">Klase:&nbsp;<input type="text" name="Klase" class="InputText" placeholder="Klase"></div><br>
					<div class="InputBlock">Ligzda:&nbsp;<input type="text" name="Ligzda" class="InputText" placeholder="Ligzda"></div><br>
					<div class="InputBlock">Darba mūžs:&nbsp;<input type="text" name="DarbaMuzs" class="InputText" placeholder="Darba mūžs"></div><br>
