...
<div id="Content">
	...
	<div class="CategoriesBlocks" id="FotoVideoBlock"><br><a class="CategoriesBlocksHref" href="digitalas_kameras.php">Digitālās kameras</a><br><br><a class="CategoriesBlocksHref" href="../Videokameras/videokameras.php">Videokameras</a><br><br><a class="CategoriesBlocksHref" href="../Binokli/binokli.php">Binokļi</a></div>
	...
	<div id="ContentRight">
		<div id="ContentRightHeader">
			<div id="ContentRightHeaderLogo"><img id="ImgContentRightHeaderLogo" src="../../Images/DigitalasKameras/digitalas_kameras.png"></div>
		</div>
			<div id="ContentRightFooter">
				<div id="InputForms">
					...
					<div class="InputBlock">Pikseļi:&nbsp;<input type="text" name="Pikseli" class="InputText" placeholder="Pikseļi"></div><br>
