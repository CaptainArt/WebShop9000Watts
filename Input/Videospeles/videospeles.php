...
<div id="Content">
	...
	<div class="CategoriesBlocks" id="VideospelesBlock"><br><a class="CategoriesBlocksHref" href="../SpeluKonsoles/spelu_konsoles.php">Spēļu konsoles</a><br><br><a class="CategoriesBlocksHref" href="videospeles.php">Videospēles</a></div>
	...
	<div id="ContentRight">
		<div id="ContentRightHeader">
			<div id="ContentRightHeaderLogo"><img id="ImgContentRightHeaderLogo" src="../../Images/Videospeles/videospeles.png"></div>
		</div>
