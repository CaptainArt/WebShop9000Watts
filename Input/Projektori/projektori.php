...
<div id="Content">
	...
	<div class="CategoriesBlocks" id="BirojaTehnikaBlock"><br><a class="CategoriesBlocksHref" href="../PapiraSmalcinataji/papira_smalcinataji.php">Papīra smalcinātāji</a><br><br><a class="CategoriesBlocksHref" href="projektori.php">Projektori</a><br><br><a class="CategoriesBlocksHref" href="../Printeri/printeri.php">Printeri</a></div>
	...
	<div id="ContentRight">
		<div id="ContentRightHeader">
			<div id="ContentRightHeaderLogo"><img id="ImgContentRightHeaderLogo" src="../../Images/Projektori/projektori.png"></div>
		</div>
			<div id="ContentRightFooter">
				<div id="InputForms">
					...
					<div class="InputBlock">Spilgtums:&nbsp;<input type="text" name="Spilgtums" class="InputText" placeholder="Spilgtums"></div><br>
