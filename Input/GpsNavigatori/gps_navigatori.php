...
<div id="Content">
	...
	<div class="CategoriesBlocks" id="AutomasinasPiederumiBlock"><br><a class="CategoriesBlocksHref" href="../Automagnetolas/automagnetolas.php">Automagnetolas</a><br><br><a class="CategoriesBlocksHref" href="../Videoregistratori/videoregistratori.php">Videoreģistrātori</a><br><br><a class="CategoriesBlocksHref" href="gps_navigatori.php">GPS Navigātori</a></div>
	<div id="ContentLeft">
	...
	<div id="ContentRight">
		<div id="ContentRightHeader">
			<div id="ContentRightHeaderLogo"><img id="ImgContentRightHeaderLogo" src="../../Images/GpsNavigatori/gps_navigatori.png"></div>
		</div>
