...
<div id="Content">
	...
	<div id="ContentRight">
		<div id="ContentRightHeader">
			<div id="ContentRightHeaderLogo"><img id="ImgContentRightHeaderLogo" src="../../Images/Automagnetolas/automagnetolas.png"></div>
		</div>
			<div id="ContentRightFooter">
				<div id="InputForms">
					...
					<div class="InputBlock">Preces foto:&nbsp;<input type="file" name="PreceFoto" class="InputText" placeholder="Preces foto"></div><br>
					...
					<div class="InputBlock">Ekvalaizers:&nbsp;<input type="text" name="Ekvalaizers" class="InputText" placeholder="Ekvalaizers"></div><br>
