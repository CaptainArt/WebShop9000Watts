...
<div id="Content">
	...
	<div class="CategoriesBlocks" id="VideospelesBlock"><br><a class="CategoriesBlocksHref" href="spelu_konsoles.php">Spēļu konsoles</a><br><br><a class="CategoriesBlocksHref" href="../Videospeles/videospeles.php">Videospēles</a></div>
	...
	<div id="ContentRight">
		<div id="ContentRightHeader">
			<div id="ContentRightHeaderLogo"><img id="ImgContentRightHeaderLogo" src="../../Images/SpeluKonsoles/spelu_konsoles.png"></div>
		</div>
