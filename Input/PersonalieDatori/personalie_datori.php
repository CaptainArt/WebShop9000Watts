...
<div id="page">
<div id="Content">
	<div class="CategoriesBlocks" id="DatoriBlock"><br><a class="CategoriesBlocksHref" href="personalie_datori.php">Personālie datori</a><br><br><a class="CategoriesBlocksHref" href="../PortativieDatori/portativie_datori.php">Portatīvie datori</a><br><br><a class="CategoriesBlocksHref" href="../Plansetdatori/plansetdatori.php">Planšetdatori</a></div>
	...
	<div id="ContentRight">
		<div id="ContentRightHeader">
			<div id="ContentRightHeaderLogo"><img id="ImgContentRightHeaderLogo" src="../../Images/PersonalieDatori/personalie_datori.png"></div>
		</div>
			<div id="ContentRightFooter">
				<div id="InputForms">
					<form method="post" action="../../Php/Input/personalie_datori_php.php" enctype="multipart/form-data">
					...
					<div class="InputBlock">Operatīvā atmiņa:&nbsp;<input type="text" name="OperativaAtmina" class="InputText" placeholder="Operatīvā atmiņa"></div><br>
					<div class="InputBlock">Processors:&nbsp;<input type="text" name="Processors" class="InputText" placeholder="Processors"></div><br>
