...
<div id="Content">
	...
	<div class="CategoriesBlocks" id="MobilieTelefoniBlock"><br><a class="CategoriesBlocksHref" href="../StacionarieTelefoni/stacionarie_telefoni.php">Stacionārie telefoni</a><br><br><a class="CategoriesBlocksHref" href="../BezvaduTelefoni/bezvadu_telefoni.php">Bezvadu telefoni</a><br><br><a class="CategoriesBlocksHref" href="mobilie_telefoni.php">Mobīlie telefoni</a></div>
	...
	<div id="ContentRight">
		<div id="ContentRightHeader">
			<div id="ContentRightHeaderLogo"><img id="ImgContentRightHeaderLogo" src="../../Images/MobilieTelefoni/mobilie_telefoni.png"></div>
		</div>
			<div id="ContentRightFooter">
				<div id="InputForms">
					...
					<div class="InputBlock">Processors:&nbsp;<input type="text" name="Processors" class="InputText" placeholder="RAM"></div><br>
					<div class="InputBlock">Atmiņa:&nbsp;<input type="text" name="Atmina" class="InputText" placeholder="Atmiņa"></div><br>
					<div class="InputBlock">Operētājsistēma:&nbsp;<input type="text" name="Operetajsistema" class="InputText" placeholder="Operētājsistēma"></div><br>
					<div class="InputBlock">Kamera:&nbsp;<input type="text" name="Kamera" class="InputText" placeholder="Kamera"></div><br>
					<div class="InputBlock">Ekrāns:&nbsp;<input type="text" name="Ekrans" class="InputText" placeholder="Ekrāns"></div><br>
