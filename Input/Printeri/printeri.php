...
<div id="Content">
	...
	<div class="CategoriesBlocks" id="BirojaTehnikaBlock"><br><a class="CategoriesBlocksHref" href="../PapiraSmalcinataji/papira_smalcinataji.php">Papīra smalcinātāji</a><br><br><a class="CategoriesBlocksHref" href="../Projektori/projektori.php">Projektori</a><br><br><a class="CategoriesBlocksHref" href="printeri.php">Printeri</a></div>
	...
	<div id="ContentRight">
		<div id="ContentRightHeader">
			<div id="ContentRightHeaderLogo"><img id="ImgContentRightHeaderLogo" src="../../Images/Printeri/printeri.png"></div>
		</div>
			<div id="ContentRightFooter">
				<div id="InputForms">
					...
					<div class="InputBlock">Drukāšanas ātrums:&nbsp;<input type="text" name="DrukasanasAtrums" class="InputText" placeholder="Drukāšanas ātrums"></div><br>
					<div class="InputBlock">Drukas izšķirtspēja:&nbsp;<input type="text" name="DrukasIzskirtspeja" class="InputText" placeholder="Drukas izšķirtspēja"></div><br>
