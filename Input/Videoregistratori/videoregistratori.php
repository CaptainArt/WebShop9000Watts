...
<div id="Content">
	...
	<div class="CategoriesBlocks" id="AutomasinasPiederumiBlock"><br><a class="CategoriesBlocksHref" href="../Automagnetolas/automagnetolas.php">Automagnetolas</a><br><br><a class="CategoriesBlocksHref" href="videoregistratori.php">Videoreģistrātori</a><br><br><a class="CategoriesBlocksHref" href="../GpsNavigatori/gps_navigatori.php">GPS Navigātori</a></div>
	<div id="ContentLeft">
	...
	<div id="ContentRight">
		<div id="ContentRightHeader">
			<div id="ContentRightHeaderLogo"><img id="ImgContentRightHeaderLogo" src="../../Images/Videoregistratori/videoregistratori.png"></div>
		</div>
			<div id="ContentRightFooter">
				<div id="InputForms">
					...
					<div class="InputBlock">Nakts filmēšana:&nbsp;<input type="text" name="NaktsFilmesana" class="InputText" placeholder="Nakts filmēšana"></div><br>
					<div class="InputBlock">Ieraksta formāts:&nbsp;<input type="text" name="IerakstaFormats" class="InputText" placeholder="Ieraksta formāts"></div><br>
					<div class="InputBlock">Izšķirtspēja:&nbsp;<input type="text" name="Izskirtspeja" class="InputText" placeholder="Izšķirtspēja"></div><br>
