...
<div id="Content">
	...
	<div class="CategoriesBlocks" id="ApgaismojumsBlock"><br><a class="CategoriesBlocksHref" href="../EnergoekonomiskasSpuldzes/energoekonomiskas_spuldzes.php">Energoekonomiskās spuldzes</a><br><br><a class="CategoriesBlocksHref" href="../LedSpuldzes/led_spuldzes.php">LED Spuldzes</a><br><br><a class="CategoriesBlocksHref" href="lukturi.php">Lukturi</a></div>
	...
	<div id="ContentRight">
		<div id="ContentRightHeader">
			<div id="ContentRightHeaderLogo"><img id="ImgContentRightHeaderLogo" src="../../Images/Lukturi/lukturi.png"></div>
		</div>
			<div id="ContentRightFooter">
				<div id="InputForms">
					...
					<div class="InputBlock">Gaismas stars:&nbsp;<input type="text" name="GaismasStars" class="InputText" placeholder="Gaismas stars"></div><br>
					<div class="InputBlock">Darbības ilgums:&nbsp;<input type="text" name="DarbibasIlgums" class="InputText" placeholder="Darbības ilgums"></div><br>
					<div class="InputBlock">Barošana:&nbsp;<input type="text" name="Barosana" class="InputText" placeholder="Barošana"></div><br>
