...
<div id="Content">
	...
	<div class="CategoriesBlocks" id="TelevizoriBlock"><br><a class="CategoriesBlocksHref" href="../LedTelevizori/led_televizori.php">LED Televīzori</a><br><br><a class="CategoriesBlocksHref" href="lcd_televizori.php">LCD Televīzori</a></div>
	...
	<div id="ContentRight">
		<div id="ContentRightHeader">
			<div id="ContentRightHeaderLogo"><img id="ImgContentRightHeaderLogo" src="../../Images/LcdTelevizori/lcd_televizori.png"></div>
		</div>
			<div id="ContentRightFooter">
				<div id="InputForms">
					<form method="post">
					<div class="InputBlock">Preces nosaukums:&nbsp;<input type="text" name="PreceNosaukums" class="InputText" placeholder="Preces nosaukums"></div><br>
					...
					<div class="InputBlock">Krāsa:&nbsp;<input type="text" name="Krasa" class="InputText" placeholder="Krāsa"></div><br>
