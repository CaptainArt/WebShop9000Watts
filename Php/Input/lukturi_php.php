...
$GaismasStars = $_POST['GaismasStars'];
$DarbibasIlgums = $_POST['DarbibasIlgums'];
$Barosana = $_POST['Barosana'];
...
$insert2 = "INSERT INTO lukturi (id_prece,talums,darbibas_ilgums,barosana) VALUES ('$id','$GaismasStars','$DarbibasIlgums','$Barosana')"; 
