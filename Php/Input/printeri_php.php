...
$DrukasanasAtrums = $_POST['DrukasanasAtrums'];
$DrukasIzskirtspeja = $_POST['DrukasIzskirtspeja'];
...
$insert2 = "INSERT INTO printeri (id_prece,drukas_atrums,drukasanas_izskirtspeja) VALUES ('$id','$DrukasanasAtrums','$DrukasIzskirtspeja')"; 
